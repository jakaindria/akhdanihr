<?php
     ...
     * @var app\modules\master\models\search\UnitKerjaSearch $searchModel
                                          ...
                                          'columns'      => [
                                              ...
                                              [
                                                  ...
                                                  'value'          => function ($model, $key, $index, $column) {
                                                      $value = $model->ishavegl ? "<i class='fa fa-check text-success'></i>" : "<i class='fa fa-times text-danger'></i>";
                                                  ...
                                                  'buttons'        => [
                                                      ...
                                                      'delete' => function ($url, $model, $key) {
                                                          return Html::a("<i class='fa fa-trash'></i>", $url, [
                                                              ...
                                                              'data'  => [
                                                                  'confirm' => \Yii::t('akhdanihr', 'Anda yakin akan menghapus') . ' ' . \Yii::t('master_unitkerja', 'Unit Kerja') . ' ' . $model->nama . '?',
                                                                  'method'  => 'DELETE'
                                                              ],
