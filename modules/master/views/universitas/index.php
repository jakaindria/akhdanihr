<?php
     ...
     * @var app\modules\master\models\search\UniversitasSearch $searchModel
        ...
        <div class="title_left">
            <h3>
                <?= \Yii::t('akhdanihr', 'List {data}', [
                    'data' => \Yii::t('master_universitas', 'Universitas')
                ]) ?>
            </h3>
        </div>
                                                  ...
                                                  'buttons'        => [
                                                      ...
                                                      'delete' => function ($url, $model, $key) {
                                                          return Html::a("<i class='fa fa-trash'></i>", $url, [
                                                              ...
                                                              'data'  => [
                                                                  'confirm' => \Yii::t('akhdanihr', 'Anda yakin akan menghapus') . ' ' . \Yii::t('master_universitas', 'Universitas') . ' ' . $model->nama . '?',
                                                                  'method'  => 'DELETE'
                                                              ],
