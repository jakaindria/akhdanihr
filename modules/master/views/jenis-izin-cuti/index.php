<?php
     ...
     * @var app\modules\master\models\search\JenisIzinCutiSearch $searchModel
     * @var yii\data\ActiveDataProvider                          $dataProvider
     */
?>
<div class="jenis-izin-cuti-index">
                ...
                echo GridView::widget([
                                          ...
                                          'columns'      => [
                                              ...
                                              [
                                                  ...
                                                  'attribute'     => 'tipe',
                                                  'format'        => 'text',
                                                  'filter'        => JenisIzinCuti::getTipeWithLabel(),
                                                  'headerOptions' => [
                                                      'class' => 'text-center'
                                                  ],
                                                  'value'         => function ($model, $key, $index, $column) {
                                                      return JenisIzinCuti::getTipeWithLabel()[$model->tipe];
                                                  }
                                              ],
                                              [
                                                  'class'         => \yii\grid\DataColumn::className(),
                                                  'attribute'     => 'hitungberdasarkan',
                                                  'format'        => 'text',
                                                  'filter'        => JenisIzinCuti::getHitungDurasiWithLabel(),
                                                  'headerOptions' => [
                                                      'class' => 'text-center'
                                                  ],
                                                  'value'         => function ($model, $key, $index, $column) {
                                                      return JenisIzinCuti::getHitungDurasiWithLabel()[$model->hitungberdasarkan];
                                                  }
                                              ],
                                                  ...
                                                  'buttons'        => [
                                                      ...
                                                      'delete' => function ($url, $model, $key) {
                                                          return Html::a("<i class='fa fa-trash'></i>", $url, [
                                                              ...
                                                              'data'  => [
                                                                  'confirm' => \Yii::t('akhdanihr', 'Anda yakin akan menghapus') . ' ' . \Yii::t('master_jenisizincuti', 'Jenis Izin / Cuti') . ' ' . $model->nama . '?',
                                                                  'method'  => 'DELETE'
                                                              ],
