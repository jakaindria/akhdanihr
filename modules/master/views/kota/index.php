<?php
     ...
     * @var app\modules\master\models\search\KotaSearch $searchModel
                ...
                echo GridView::widget([
                                          ...
                                          'columns'      => [
                                              ...
                                              [
                                                  'class'     => \yii\grid\DataColumn::className(),
                                                  'attribute' => 'provinsi',
                                                  'label'     => \Yii::t('master_kota', 'Provinsi'),
                                                  'format'    => 'text',
                                                  'value'     => 'provinsi.nama'
                                              ],
                                                  ...
                                                  'buttons'        => [
                                                      ...
                                                      'delete' => function ($url, $model, $key) {
                                                          return Html::a("<i class='fa fa-trash'></i>", $url, [
                                                              ...
                                                              'data'  => [
                                                                  'confirm' => \Yii::t('akhdanihr', 'Anda yakin akan menghapus') . ' ' . \Yii::t('master_kota', 'Kota') . ' ' . $model->nama . '?',
                                                                  'method'  => 'DELETE'
                                                              ],
