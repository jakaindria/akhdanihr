<?php
     ...
     * @var app\modules\master\models\search\ProvinsiSearch $searchModel
                                                  ...
                                                  'buttons'        => [
                                                      ...
                                                      'delete' => function ($url, $model, $key) {
                                                          return Html::a("<i class='fa fa-trash'></i>", $url, [
                                                              ...
                                                              'data'  => [
                                                                  'confirm' => \Yii::t('akhdanihr', 'Anda yakin akan menghapus') . ' ' . \Yii::t('master_provinsi', 'Provinsi') . ' ' . $model->nama . '?',
                                                                  'method'  => 'DELETE'
                                                              ],
