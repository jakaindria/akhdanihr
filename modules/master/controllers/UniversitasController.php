<?php
    ...
    use app\modules\master\models\search\UniversitasSearch;
    ...
    class UniversitasController extends Controller {
         ...
         * @param integer $id
         *
         * @return Universitas|null Model yang digunakan
         * @throws \Exception
         */
        protected function findModel($id) {
            if (($model = Universitas::findOne($id)) !== NULL) {
                return $model;
            }else{
