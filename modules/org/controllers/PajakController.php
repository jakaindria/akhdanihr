<?php
    ...
    use app\modules\org\models\search\PajakSearch as PajakSearch;
    use Yii;
    ...
    /**
     * PajakController implements the CRUD actions for Pajak model.
     */
    class PajakController extends Controller {
         ...
         * @param integer $id
         *
         * @return Pajak|null Model yang digunakan
         * @throws \Exception
         */
        protected function findModel($id) {
            if (($model = Pajak::findOne($id)) !== NULL) {
                return $model;
            }else{
