            ...
            <?php try {
                echo GridView::widget([
                                          ...
                                          'columns'      => [
                                              ...
                                              [
                                                  'class'         => \yii\grid\DataColumn::className(),
                                                  'attribute'     => 'kualifikasi',
                                                  'format'        => 'text',
                                                  'filter'        => IzinUsaha::getKualifikasiWithLabel(),
                                                  'headerOptions' => [
                                                      'class' => 'text-center'
                                                  ],
                                                  'value'         => function ($model, $key, $index, $column) {
                                                      return IzinUsaha::getKualifikasiWithLabel()[$model->kualifikasi];
                                                  }
                                              ],
                                              [
                                                  'class'         => \yii\grid\DataColumn::className(),
                                                  ...
                                                  'buttons'        => [
                                                      ...
                                                      'delete' => function ($url, $model, $key) {
                                                          return Html::a("<i class='fa fa-trash'></i>", $url, [
                                                              ...
                                                              'data'  => [
                                                                  'confirm' => \Yii::t('akhdanihr', 'Anda yakin akan menghapus') . ' ' . \Yii::t('org_izinusaha', 'Izin Usaha') . ' ' . $model->jenis . '?',
                                                                  'method'  => 'DELETE'
                                                              ],
