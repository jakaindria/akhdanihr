<?php
     ...
     * @var app\modules\system\models\search\RoleSearch $searchModel
                                          ...
                                          'columns'      => [
                                              ...
                                              [
                                                  ...
                                                  'value'          => function ($model, $key, $index, $column) {
                                                      $value = $model->islinktounitkerja ? "<i class='fa fa-check text-success'></i>" : "<i class='fa fa-times text-danger'></i>";
                                              ...
                                              [
                                                  ...
                                                  'value'          => function ($model, $key, $index, $column) {
                                                      $value = $model->isbuiltin ? "<i class='fa fa-check text-success'></i>" : "<i class='fa fa-times text-danger'></i>";
                                                  ...
                                                  'buttons'        => [
                                                      ...
                                                      'permission' => function ($url, $model, $key) {
                                                          return Html::a("<i class='fa fa-key'></i>", $url, [
                                                              ...
                                                              'style' => 'margin-bottom: 0',
                                                              'title' => \Yii::t("system_role", 'Permission')
                                                          ]);
                                                      },
                                                      'delete'     => function ($url, $model, $key) {
                                                          return $model->isbuiltin == 1 ? '' : Html::a("<i class='fa fa-trash'></i>", $url, [
                                                              'class' => 'btn btn-sm btn-danger text-center',
                                                              'style' => 'margin-bottom: 0; margin-right: 0',
                                                              'data'  => [
                                                                  'confirm' => \Yii::t('akhdanihr', 'Anda yakin akan menghapus') . ' ' . \Yii::t('system_role', 'User Role') . ' ' . $model->nama . '?',
                                                                  'method'  => 'DELETE'
                                                              ],
